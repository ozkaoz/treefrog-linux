...
UPGRADE_FILE=${BINARIES_DIR}/for-upgrade/${BR2_EXTERNAL_HCFOTA_FILENAME}
...
if [ -f vmlinux ] ; then
	OS_NAME=linux
	APP_PROJECTOR="PROJECTORAPP"
	APP_SCREEN="SCREENAPP"
else
	OS_NAME=rtos
	APP_PROJECTOR="APPS_PROJECTOR"
	APP_SCREEN="APPS_HCSCREEN"
